    ...
    <div className="footer bg-gray-100 text-gray-600 py-10">
      <div className="container mx-auto">
        <div className="top flex flex-wrap justify-between">
          ...
          Kami adalah platform freebies yang menyediakan beragam konten gratis untuk membantu Anda memajukan proyek kreatif Anda. 
          Mulai dari desain grafis, template, hingga sumber daya digital lainnya, kami berkomitmen untuk memfasilitasi perjalanan kreatif Anda tanpa biaya tambahan. 
          Jelajahi koleksi kami, temukan inspirasi baru, dan tingkatkan kualitas karya Anda dengan sumber daya gratis yang kami sediakan. 
          Bergabunglah dengan komunitas kami dan rasakan kebebasan berekspresi di dunia kreatif!"
          </p>
        </div>
