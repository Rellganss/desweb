...
function Footer() {
  return (
    <div className="footer bg-teal-700 text-gray-200 py-10 absolute-bottom w-full  ">
      <div className="container sm:w-full md:w-full lg:w-full xl:w-full mx-auto">
        <div className="top flex flex-wrap justify-between">
          <div className="item mx-2 mb-6">
          ...
          <p className="md:ml-auto max-w-lg mx-2 text-justify ">
            "FreeDers adalah platform lowongan freelance yang menghubungkan
            pekerja freelance dengan proyek-proyek menarik dari berbagai bidang"
          </p>
        </div>
        <div className="border-t my-8 mr-[50px] sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 " />
      </div>
      <div className=" w-full mx-auto">
        <div className="bottom flex flex-col md:flex-row  justify-between items-center">
          <div className="left flex items-center gap-4 ml-[40px] w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 sm:ml-[20px] md:ml-[40px] lg:ml-[60px] xl:ml-[100px]  ">
